...
- [x] Requisito Opcional 2: Salvar os dados de saída em um banco de dados relacional (etl.db).
- [x] Requisito Opcional 3: Realização de Inner Join em F# para unir as tabelas de pedidos e itens.
